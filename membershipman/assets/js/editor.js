    ...
    Redactor.fn = $.Redactor.prototype = {
        ...
        imageEdit: function(image) {
            ...
            var callback = $.proxy(function() {
                ...
                $("#redactor_form_image_align").selecter();
            }, this);
		...
		modalTemplatesInit: function()
		{
			$.extend( this.opts,
			{
				...
				modal_link: String()
				+ '<section id="redactor-modal-link-insert" class="wojo form">'
					//+ '<div class="field"><label>' + this.opts.curLang.ilink + '</label>'
					//+ '<select id="redactor-predefined-links"><option value="0">--- Select Link ---</option></select></div>'
				...
				modal_table: String()
				+ '<section id="redactor-modal-table-insert" class="wojo form">'
				...
				+ '<section id="redactor-modal-video-insert">'
					+ '<form id="redactorInsertVideoForm" class="wojo form">'
			   ...
			   + '<div id="redactor_tabs">' 
				...
				+ '</div>' 
				+ '<div id="redactor_tab1" class="redactor_tab wojo segment full fit form">' 
				+ '<div data-modal-select="true" class="wojo fluid selection dropdown">' 
				...
				+ '</div>' 
				+ '</div>' 
				+ ' <div id="redactor_tab2" class="redactor_tab wojo segment full fit form" style="display: none;">' 
				+ '<div id="uploader">' 
        ...
        getFiles: function() {
            $.ajax({
                ...
                beforeSend: function() {
                    $("#cms_files .wojo.form").addClass('loading');
                },
                success: function(json) {
                    if (json.type == "success") {
                        setTimeout(function() {
                            $("#cms_files .wojo.form").removeClass('loading');
                        }, 250);
