<?php
  ...
  final class Filter
  {
      ...
      {
          self::$showMsg = "<div class=\"wojo error message\"><i class=\"close icon\"></i><div class=\"header\">" . Core::$word->SYSTEM_ERR . "</div><div class=\"content\"><ul class=\"wojo list\">";
      ...
      {
          self::$showMsg = "<ul class=\"wojo list\">";
          $i = count(self::$showMsg);
          foreach (self::$msgs as $msg) {
              self::$showMsg .= "<li>" . $msg . "</li>\n";
          }
